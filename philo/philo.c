...
/*   Updated: 2025/06/02 23:11:50 by kkoujan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*monitoring(void *data)
{
	...
	while (!is_dead)
	{
		...
		{
			if (get_timestamp(philo_data->data->start_time) - philo_data->data->philosophers[i]->eat_time >= philo_data->data->time_to_die)
			{
				is_dead = 1;
